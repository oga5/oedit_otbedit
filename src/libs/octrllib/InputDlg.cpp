...
BOOL CInputDlg::OnInitDialog()
{
	...
	int win_width = dlg_rect.Width() + ::GetSystemMetrics(SM_CXFIXEDFRAME) * 2;
	int win_height = btn_y + btn_h + 10 + ::GetSystemMetrics(SM_CYCAPTION) + ::GetSystemMetrics(SM_CYFIXEDFRAME) * 2;
