...
private:
	...
	BOOL CheckDoubleBoot(CCommandLineInfo &cmdInfo);
	...
	CDocument *OpenDocumentFile2(LPCTSTR lpszFileName);

	BOOL CreateFont();
	BOOL CreateTabFont();
	
	BOOL OpenFiles(CCommandLineInfo &cmdInfo, TCHAR *cmd_line);
