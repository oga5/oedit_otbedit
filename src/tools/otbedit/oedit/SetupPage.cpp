...
void CSetupPage::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO_FILE_LIST_FILTER, m_combo_file_list_filter);
	...
	DDX_CBString(pDX, IDC_COMBO_FILE_LIST_FILTER, m_file_list_filter);
...
BOOL CSetupPage::OnInitDialog() 
{
	...
	m_combo_file_list_filter.InsertString(0, m_file_list_filter);
...
{
	m_combo_file_list_filter.InsertString(0, _T("*.txt;*.htm;*.html;*.c;*.cpp;*.h;*.java;*.pl;*.cgi;*.sql;*.ora;*.log"));
	m_combo_file_list_filter.InsertString(1, _T("*.*"));
	m_combo_file_list_filter.InsertString(2, _T("*.txt"));
	m_combo_file_list_filter.InsertString(3, _T("*.htm;*.html"));
	m_combo_file_list_filter.InsertString(4, _T("*.c;*.cpp;*.h"));
	m_combo_file_list_filter.InsertString(5, _T("*.java"));
	m_combo_file_list_filter.InsertString(6, _T("*.pl;*.cgi"));
	m_combo_file_list_filter.InsertString(7, _T("*.sql;*.ora;*.log"));
}
