...
//        (HBRUSH) GetClassLong(m_hWnd, GCL_HBRBACKGROUND)));
    ...
    // Note: The above line was replaced with the following
    // Updated GetClassLong to GetClassLongPtr and GCL_HBRBACKGROUND to GCLP_HBRBACKGROUND
    // to ensure compatibility with 64-bit systems and modern Windows SDKs.
    mdc.FillRect(rcDraw, CBrush::FromHandle(
